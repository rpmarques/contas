...
if ($_POST) {
  if (isset($_POST['id'])) {
    ...
    $ret = $objClientes->update($nome, $cnpj, $fone1, $fone2, $email, $rContato, $clienteId);
    $cliente = $objClientes->pegaCli($clienteId);
  }
}
?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control form-control-sm cnpj" name="cnpj" data-inputmask='"mask": "99.999.999/9999-99"' data-mask value=""> -->
                      </div>
                    </div>
                    <!-- <div class="col-md-3">
                      <div class="form-group">
